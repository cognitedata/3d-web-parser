...
describe('customFileParser', () => {
  ...
  test('parse file 42', async() => {
    ...
    let expectedColors = [[ 30, 144, 255, 255 ], [ 255, 0, 0, 255 ], [ 255, 255, 255, 255 ], [ 142, 92, 0, 255 ], [ 50, 205, 50, 255 ], [ 0, 255, 255, 255 ], [ 255, 255, 0, 255 ]]
    ...
    let expectedYTranslations: any = [];
    let expectedZTranslations: any = [];
    ...
    let expectedGeometryIndexes: any = {
      1: [7060329795587960, 1043, 1, 36, 34, 47, 0, 0, 0, 10, 0, 2920898236136174, 2420, 4, 97, 707, 50, 0, 3, 4],
      2: [8164540613673614, 2631, 2, 313, 112, 13, 3, 10, 2332139652741056, 3137, 2, 48, 258, 1, 2, 10, 5768382459793153, 1355, 1, 106],
      3: [927342382680797, 2778, 2, 15, 287, 2, 2, 0, 4, 16, 2412602947335905, 3516, 2, 80, 105, 9, 11, 14, 8, 6],
      4: [5869005083795563, 3346, 2, 3, 121, 0, 1, 7, 34, 7392096689693635, 3167, 2, 75, 260, 1, 1, 150, 2, 83056106740777, 4630],
      ...
      15: [8922988493723012, 2092, 5, 55, 158, 90, 0, 54, 24, 1828017180807764, 2172, 4, 4, 63, 0, 2, 9, 1, 2317576119257839, 2171],
      ...
      22: [1080060884278809, 4305, 3, 22, 52, 77, 0, 43, 30, 7160316963937309, 2962, 2, 161, 618, 10, 1, 4, 0, 6626953872348268, 4931],
      100: [4820468089466959, 3425, 2, 2, 2373107104903371, 1340, 40, 1, 2740906351331585, 3084, 2, 2, 7453191589183843, 4760, 12, 3, 7022047152622673, 1243, 20, 1]
    }
