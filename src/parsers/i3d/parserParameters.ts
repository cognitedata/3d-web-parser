...
export type FilePropertyArrayNameType =
  ...
  | 'fileId'
  | 'texture';
export const FilePropertyArrayNamesV5: FilePropertyArrayNameType[] = [
  'color',
  'size',
  'centerX',
  'centerY',
...
export const FilePropertyArrayNamesV7: FilePropertyArrayNameType[] = [
  'color',
  'size',
  'centerX',
  'centerY',
...
export const fileGeometryPropertiesV5: { [name in FileGeometryNameType]: FilePropertyNames[] } = {
...
export const fileGeometryPropertiesV7: { [name in FileGeometryNameType]: FilePropertyNames[] } = {
  Box: ['treeIndex', 'color', 'size', 'center', 'normal', 'delta', 'rotationAngle'],
  Circle: ['treeIndex', 'color', 'size', 'center', 'normal', 'radiusA'],
  ClosedCone: ['treeIndex', 'color', 'size', 'center', 'normal', 'height', 'radiusA', 'radiusB'],
  ClosedCylinder: ['treeIndex', 'color', 'size', 'center', 'normal', 'height', 'radiusA'],
