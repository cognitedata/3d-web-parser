...
function addOpenTorusSegment(
  groups: { [name: string]: PrimitiveGroup },
  data: PropertyLoader,
  filterOptions?: FilterOptions
) {
  (groups.TorusSegment as TorusSegmentGroup).add(
    data.nodeId,
    data.treeIndex,
    data.size,
    data.center,
...
function addClosedTorusSegment(
  groups: { [name: string]: PrimitiveGroup },
  data: PropertyLoader,
  filterOptions?: FilterOptions
) {
...
function addTorus(groups: { [name: string]: PrimitiveGroup }, data: PropertyLoader, filterOptions?: FilterOptions) {
  (groups.TorusSegment as TorusSegmentGroup).add(
    data.nodeId,
    data.treeIndex,
    data.size,
